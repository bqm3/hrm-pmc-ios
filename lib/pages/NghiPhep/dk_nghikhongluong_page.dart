...
class ManyDayDialog2 extends StatefulWidget {
...
class _ManyDayDialogState extends State<ManyDayDialog2> {
  ...
  Future<void> fetchLoaiNghiList() async {
    ...
    List<LoaiNghi>? loaiNghiList =
        await loaiNghiRepo.getLoaiNghi(table: "DM_CaLamViec", parrent: "0");
  ...
  Future<void> sendRequest() async {
    ...
    if (response.statusCode == 200) {
      ...
      Future.delayed(Duration(milliseconds: 100), () {
        Get.dialog(
          thongBaoDialog(text: 'Đăng ký nghỉ thành công'),
        );
      });
